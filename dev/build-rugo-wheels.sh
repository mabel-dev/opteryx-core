...
# rugo has no Rust extension and no http_client. It DOES need libcrypto, because
# rugo.parquet_reader links -lcrypto on Linux (build_common.parquet_link_args),
# so openssl-devel is installed for the headers/lib; auditwheel vendors it in.
#
