...
# against BEFORE importing anything that resolves draken_* symbols — otherwise
# the mismatch surfaces as an undefined symbol at first query, or as a fault
# inside native code much later. Generated by build_common at build time.
from opteryx._draken_abi import check_draken_abi
