...
class TestVectorVectorComparisons:
    ...
    def test_int64_equals_int64(self):
        """Test Integer64Vector == Integer64Vector"""
        vec1 = Integer64Vector.from_arrow(pa.array([1, 2, 3, None], type=pa.int64()))
        vec2 = Integer64Vector.from_arrow(pa.array([1, 2, 4, None], type=pa.int64()))
    ...
    def test_int64_less_than_int64(self):
        """Test Integer64Vector < Integer64Vector"""
        vec1 = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
        vec2 = Integer64Vector.from_arrow(pa.array([2, 2, 2], type=pa.int64()))
    ...
    def test_integer_equals_integer(self):
        """Test Integer32Vector == Integer32Vector"""
        vec1 = Integer32Vector.from_arrow(pa.array([1, 2, 3], type=pa.int32()))
        vec2 = Integer32Vector.from_arrow(pa.array([1, 2, 4], type=pa.int32()))
        result = draken_compare("Eq", vec1, vec2)

        assert result.to_pylist() == [True, True, False]

    def test_int64_equals_integer(self):
        """Test Integer64Vector == Integer32Vector (mixed int types)"""
        try:
            vec1 = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
            vec2 = Integer32Vector.from_arrow(pa.array([1, 2, 4], type=pa.int32()))
            result = draken_compare("Eq", vec1, vec2)
...
class TestVectorScalarComparisons:
    ...
    def test_int64_vector_equals_scalar_int(self):
        """Test Integer64Vector == scalar int"""
        vec = Integer64Vector.from_arrow(pa.array([1, 2, 3, 2, None], type=pa.int64()))
...
class TestScalarVectorComparisons:
    ...
    def test_scalar_greater_than_vector(self):
        ...
        vec = Integer64Vector.from_arrow(pa.array([1, 5, 3], type=pa.int64()))
    ...
    def test_scalar_equals_vector(self):
        ...
        vec = Integer64Vector.from_arrow(pa.array([1, 5, 3, 5], type=pa.int64()))
...
class TestNegateOperations:
    ...
    def test_negate_eq_becomes_neq(self):
        ...
        vec1 = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
        vec2 = Integer64Vector.from_arrow(pa.array([1, 2, 4], type=pa.int64()))
    ...
    def test_negate_in_list_becomes_not_in_list(self):
        ...
        vec = Integer64Vector.from_arrow(pa.array([1, 2, 3, 4], type=pa.int64()))
    ...
    def test_negate_with_nulls(self):
        ...
        vec1 = Integer64Vector.from_arrow(pa.array([1, None, 3], type=pa.int64()))
        vec2 = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
        result = draken_compare("NotEq", vec1, vec2)
...
class TestEdgeCases:
    ...
    def test_all_null_vector(self):
        ...
        vec1 = Integer64Vector.from_arrow(pa.array([None, None, None], type=pa.int64()))
        vec2 = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
        result = draken_compare("Eq", vec1, vec2)
    ...
    def test_empty_vector(self):
        ...
        vec1 = Integer64Vector.from_arrow(pa.array([], type=pa.int64()))
        vec2 = Integer64Vector.from_arrow(pa.array([], type=pa.int64()))
        result = draken_compare("Eq", vec1, vec2)
    ...
    def test_mixed_null_and_values(self):
        ...
        vec = Integer64Vector.from_arrow(pa.array([1, None, 3, None, 5], type=pa.int64()))
        result = draken_compare("Gt", vec, 2)
    ...
    def test_large_int64_values(self):
        ...
        vec = Integer64Vector.from_arrow(
...
class TestSetOperations:
    ...
    def test_in_list_with_ints(self):
        ...
        vec = Integer64Vector.from_arrow(pa.array([1, 2, 3, 4, 5], type=pa.int64()))
    ...
    def test_in_list_with_null_in_vector(self):
        ...
        vec = Integer64Vector.from_arrow(pa.array([1, None, 3], type=pa.int64()))
...
class TestTypeConversions:
    ...
    def test_int64_vs_float64(self):
        """Test Integer64Vector compared to Float64Vector (should cast)"""
        int_vec = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
    ...
    def test_int64_scalar_to_float(self):
        """Test Integer64Vector compared to float scalar (should coerce)"""
        vec = Integer64Vector.from_arrow(pa.array([1, 2, 3], type=pa.int64()))
