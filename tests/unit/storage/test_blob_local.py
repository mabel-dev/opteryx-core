...
STATEMENTS = [
    ...
    ("SELECT * FROM testdata.planets, testdata.satellites WHERE testdata.planets.id = testdata.satellites.planetId;", 177, 28, None),
    ("SELECT * FROM testdata.planets CROSS JOIN testdata.satellites WHERE testdata.planets.id = testdata.satellites.planetId;", 177, 28, None),
    ("SELECT * FROM testdata.planets INNER JOIN testdata.satellites ON testdata.planets.id = testdata.satellites.planetId;", 177, 28, None),
