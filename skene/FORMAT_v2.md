> **FROZEN — the v2 specification, preserved verbatim at the v3 bump (2026-09-24).**
> v2 is the N-1 version the v3 build reads and migrates (FORMAT.md §12); this
> text and the golden fixtures in `tests/fixtures/v2/` define its bytes. It is
> not edited again. The current format is described in [FORMAT.md](FORMAT.md).
