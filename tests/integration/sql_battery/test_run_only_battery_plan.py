...
if __name__ == "__main__":  # pragma: no cover
    ...
    print(f"RUNNING BATTERY OF {len(RUN_ONLY_TESTS)} RUN_ONLY PLAN TESTS")
    for index, statement in enumerate(RUN_ONLY_TESTS):
        ...
        try:
            test_run_only_tests_plan(statement)
