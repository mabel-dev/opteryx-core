...
def test_filter_node_is_stateless():
    ...
    assert get_registry().get_by_kind("FilterNode").is_stateless is True, "FilterNode should be stateless"
...
def test_projection_node_is_stateless():
    ...
    assert (
        get_registry().get_by_kind("ProjectionNode").is_stateless is True
