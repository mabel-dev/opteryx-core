#pragma once
//
// Templated comparison kernels for Float64Vector.
//
...
// match the existing null-density gating in float64_vector.pyx:
...
struct Eq { static inline bool apply(double a, double b) { return a == b; } };
struct Ne { static inline bool apply(double a, double b) { return a != b; } };
struct Gt { static inline bool apply(double a, double b) { return a >  b; } };
struct Ge { static inline bool apply(double a, double b) { return a >= b; } };
struct Lt { static inline bool apply(double a, double b) { return a <  b; } };
struct Le { static inline bool apply(double a, double b) { return a <= b; } };
...
// per-row branching on op. op codes match float64_vector.pyx convention:
//   0=eq  1=ne  2=gt  3=ge  4=lt  5=le
// ---------------------------------------------------------------------------

static inline bool dispatch_compare_once(int op, double a, double b) {
    switch (op) {
