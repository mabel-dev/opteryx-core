...
def test_predicate_pushdowns_firestore():
    ...
    assert cur.telemetry.get("rows_read", 0) == 7, cur.telemetry
    ...
    assert cur.rowcount == 2, cur.rowcount
    assert cur.telemetry.get("rows_read", 0) == 2, cur.telemetry
    ...
    assert cur.telemetry.get("rows_read", 0) == 1, cur.telemetry
    ...
    assert cur.telemetry.get("rows_read", 0) == 0, cur.telemetry
