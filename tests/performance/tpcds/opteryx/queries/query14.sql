     ...
     (SELECT iss.i_brand_id brand_id,
      ...
      WHERE ss_item_sk = iss.i_item_sk
        ...
        FROM testdata.tpcds_tiny.catalog_sales,
             testdata.tpcds_tiny.item ics,
             testdata.tpcds_tiny.date_dim d2 WHERE cs_item_sk = ics.i_item_sk
        ...
        FROM testdata.tpcds_tiny.web_sales,
             testdata.tpcds_tiny.item iws,
             testdata.tpcds_tiny.date_dim d3 WHERE ws_item_sk = iws.i_item_sk
