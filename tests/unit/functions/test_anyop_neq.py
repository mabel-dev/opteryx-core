...
def _test_neq_comparison(literal, test_value, expected_result, _type=pa.string()):
    ...
    result = list_anyop_neq(literal, array).to_pylist()
...
def test_comparison_with_int_lists():
    ...
    result = list_anyop_neq(1, array).to_pylist()
...
def test_comparison_with_string_lists():
    ...
    result = list_anyop_neq("apple", array).to_pylist()
    ...
    result = list_anyop_neq("a", array).to_pylist()
    ...
    result = list_anyop_neq("", array).to_pylist()
    ...
    result = list_anyop_neq("a b", array).to_pylist()
...
def test_comparison_with_binary_lists():
    ...
    result = list_anyop_neq(b"data", array).to_pylist()
    ...
    result = list_anyop_neq(b"", array).to_pylist()
    ...
    result = list_anyop_neq(b"\x00\x01\x02", array).to_pylist()
    ...
    result = list_anyop_neq(large_binary, array).to_pylist()
    ...
    result = list_anyop_neq(b"\xf0\x9f\x98\x80", array).to_pylist()
...
def test_comparison_list_floats():
    ...
    result = list_anyop_neq(1.0, array).to_pylist()
...
def test_comparison_list_dates():
    ...
    result = list_anyop_neq(date1_days, array).to_pylist()
