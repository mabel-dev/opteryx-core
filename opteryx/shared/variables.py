...
SYSTEM_VARIABLES_DEFAULTS: Dict[str, VariableSchema] = {
    ...
    "lower_case_table_names": (OrsoTypes.INTEGER, 1, VariableOwner.SERVER, Visibility.RESTRICTED),
    "lower_case_column_names": (OrsoTypes.INTEGER, 1, VariableOwner.SERVER, Visibility.RESTRICTED),
