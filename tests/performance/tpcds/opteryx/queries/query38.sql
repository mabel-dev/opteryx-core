  ...
  (SELECT DISTINCT c_last_name,
   ...
   WHERE testdata.tpcds_tiny.store_sales.ss_sold_date_sk = testdata.tpcds_tiny.date_dim.d_date_sk
     ...
     FROM testdata.tpcds_tiny.catalog_sales,
          testdata.tpcds_tiny.date_dim,
          testdata.tpcds_tiny.customer WHERE testdata.tpcds_tiny.catalog_sales.cs_sold_date_sk = testdata.tpcds_tiny.date_dim.d_date_sk
     ...
     FROM testdata.tpcds_tiny.web_sales,
          testdata.tpcds_tiny.date_dim,
          testdata.tpcds_tiny.customer WHERE testdata.tpcds_tiny.web_sales.ws_sold_date_sk = testdata.tpcds_tiny.date_dim.d_date_sk
