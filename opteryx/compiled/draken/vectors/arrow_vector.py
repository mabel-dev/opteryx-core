...
from opteryx.compiled.draken.vectors.vector import Vector  # type: ignore[attr-defined]
...
class ArrowVector(Vector):
    ...
    @property
    def dtype(self):
        from opteryx.compiled.draken.interop.arrow import arrow_type_to_draken
