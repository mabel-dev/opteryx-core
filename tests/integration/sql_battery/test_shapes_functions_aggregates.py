...
STATEMENTS = [
        ...
        ("SELECT name, COUNT(*) AS count FROM testdata.satellites GROUP BY name HAVING count > 1", 0, 2, None),

        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY '%apoll%'", 0, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions ILIKE ANY '%apoll%'", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%apoll%')", 0, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions ILIKE ANY ('%apoll%')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%Apoll%')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions ILIKE ANY ('%Apoll%')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%Apoll%', 'mission')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions ILIKE ANY ('%Apoll%', 'mission')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY '%apoll%'", 334, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT ILIKE ANY '%apoll%'", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ('%apoll%')", 334, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT ILIKE ANY ('%apoll%')", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ('%Apoll%')", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT ILIKE ANY ('%Apoll%')", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ('%Apoll%', 'mission')", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT ILIKE ANY ('%Apoll%', 'mission')", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('Apoll%', 'Gemini%', 'Mercury%')", 37, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ('Apoll%', 'Gemini%', 'Mercury%')", 297, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ()", 0, 2, SqlError),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ()", 0, 2, SqlError),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%Apoll%', null)", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ('%Apoll%', null)", 300, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%aPoll%')", 0, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions ILIKE ANY ('%aPoll%')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('Apollo 11')", 3, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions NOT LIKE ANY ('Apollo 11')", 331, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('Apollo_%')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('Apo__o%')", 34, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%Apoll%', 123)", 34, 2, IncompatibleTypesError),
        ("SELECT name, missions FROM testdata.astronauts WHERE missions LIKE ANY ('%pattern1%', '%pattern2%', '%pattern3%', '%pattern4%', '%pattern5%', '%pattern6%', '%pattern7%', '%pattern8%', '%pattern9%', '%pattern10%', '%pattern11%', '%pattern12%', '%pattern13%', '%pattern14%', '%pattern15%', '%pattern16%', '%pattern17%', '%pattern18%', '%pattern19%', '%pattern20%', '%pattern21%', '%pattern22%', '%pattern23%', '%pattern24%', '%pattern25%', '%pattern26%', '%pattern27%', '%pattern28%', '%pattern29%', '%pattern30%', '%pattern31%', '%pattern32%', '%pattern33%', '%pattern34%', '%pattern35%', '%pattern36%', '%pattern37%', '%pattern38%', '%pattern39%', '%pattern40%', '%pattern41%', '%pattern42%', '%pattern43%', '%pattern44%', '%pattern45%', '%pattern46%', '%pattern47%', '%pattern48%', '%pattern49%', '%pattern50%');", 0, 2, None),

        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY '%armstrong%'", 0, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name ILIKE ANY '%armstrong%'", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%arms%')", 0, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name ILIKE ANY ('%arms%')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%Armstrong%')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name ILIKE ANY ('%Arms%')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%Armstrong%', 'mission')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name ILIKE ANY ('%Armstrong%', 'mission')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY '%armstrong%'", 357, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT ILIKE ANY '%armstrong%'", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ('%armstrong%')", 357, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT ILIKE ANY ('%armstrong%')", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ('%Armstrong%')", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT ILIKE ANY ('%Armstrong%')", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ('%Armstrong%', 'mission')", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT ILIKE ANY ('%Armstrong%', 'mission')", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%Armstrong%', '%Aldrin%', '%Collins%')", 4, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ('%Armstrong%', '%Aldrin%', '%Collins%')", 353, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ()", 0, 2, SqlError),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ()", 0, 2, SqlError),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%Armstrong%', null)", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ('%Armstrong%', null)", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%aRmstrong%')", 0, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name ILIKE ANY ('%aRmstrong%')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('Neil A. Armstrong')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name NOT LIKE ANY ('Neil A. Armstrong')", 356, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%__Armstrong%')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%Arm__rong%')", 1, 2, None),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%Armstrong%', 123)", 1, 2, IncompatibleTypesError),
        ("SELECT name, missions FROM testdata.astronauts WHERE name LIKE ANY ('%pattern1%', '%pattern2%', '%pattern3%', '%pattern4%', '%pattern5%', '%pattern6%', '%pattern7%', '%pattern8%', '%pattern9%', '%pattern10%', '%pattern11%', '%pattern12%', '%pattern13%', '%pattern14%', '%pattern15%', '%pattern16%', '%pattern17%', '%pattern18%', '%pattern19%', '%pattern20%', '%pattern21%', '%pattern22%', '%pattern23%', '%pattern24%', '%pattern25%', '%pattern26%', '%pattern27%', '%pattern28%', '%pattern29%', '%pattern30%', '%pattern31%', '%pattern32%', '%pattern33%', '%pattern34%', '%pattern35%', '%pattern36%', '%pattern37%', '%pattern38%', '%pattern39%', '%pattern40%', '%pattern41%', '%pattern42%', '%pattern43%', '%pattern44%', '%pattern45%', '%pattern46%', '%pattern47%', '%pattern48%', '%pattern49%', '%pattern50%');", 0, 2, None),
        ...
        ("SELECT max(current_timestamp), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT max(1), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT max(1) FROM testdata.satellites", 1, 1, None),
        ("SELECT max('a'), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT max('a') FROM testdata.satellites", 1, 1, None),
        ("SELECT min(current_timestamp), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT min(1), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT min(1) FROM testdata.satellites", 1, 1, None),
        ("SELECT min('a'), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT min('a') FROM testdata.satellites", 1, 1, None),
        ("SELECT count(current_timestamp), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT count(1), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT count(1) FROM testdata.satellites", 1, 1, None),
        ("SELECT count('a'), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT count('a') FROM testdata.satellites", 1, 1, None),
        ("SELECT avg(1), name FROM testdata.satellites group by name", 177, 2, None),
        ("SELECT avg(1) FROM testdata.satellites", 1, 1, None),
        ...
        ("SELECT * FROM testdata.satellites WHERE id > 1_00", 77, 8, None),
        ("SELECT * FROM testdata.satellites WHERE radius > 10.0_0", 77, 8, None),
        ("SELECT * FROM testdata.satellites WHERE radius > 10.0_0 and id > 1_00", 42, 8, None),
        ...
        ("SELECT DISTINCT alma_mater AS AM FROM testdata.astronauts", 281, 1, None), # LIST<VARCHAR>
        ("SELECT DISTINCT birth_place FROM testdata.astronauts", 272, 1, None), # JSONB/STRUCT
        ("SELECT DISTINCT death_date AS AM FROM testdata.astronauts", 39, 1, None), # TIMESTAMP
        ...
        ("SELECT CAST(p.name AS ARRAY<VARCHAR>) FROM testdata.satellites as s LEFT JOIN $planets as p ON s.id = p.id WHERE s.id > 10", 167, 1, None),
        ("SELECT CAST(p.id AS ARRAY<VARCHAR>) FROM testdata.satellites as s LEFT JOIN $planets as p ON s.id = p.id WHERE s.id > 10", 167, 1, None),
        ("SELECT CAST(p.mass AS ARRAY<VARCHAR>) FROM testdata.satellites as s LEFT JOIN $planets as p ON s.id = p.id WHERE s.id > 10", 167, 1, None),
        ("SELECT CAST(p.name AS ARRAY<INTEGER>) FROM testdata.satellites as s LEFT JOIN $planets as p ON s.id = p.id WHERE s.id > 10", 167, 1, None),
        ("SELECT CAST(p.id AS ARRAY<INTEGER>) FROM testdata.satellites as s LEFT JOIN $planets as p ON s.id = p.id WHERE s.id > 10", 167, 1, None),
        ...
        ("SELECT * FROM $planets LEFT JOIN (SELECT planetId as id FROM testdata.satellites WHERE id < 0) USING (id)", 9, 20, None),
        ("SELECT * FROM $planets LEFT JOIN (SELECT planetId as id FROM testdata.satellites WHERE id < 0) AS S USING (id)", 9, 20, None),
        ...
        ("SELECT SORT(ARRAY_AGG(name)) as NAMES FROM testdata.satellites GROUP BY planetId", 7, 1, None),
        ("SELECT LEAST(ARRAY_AGG(DISTINCT name LIMIT 5)) as NAMES FROM testdata.satellites GROUP BY planetId", 7, 1, None),
        ("SELECT SORT(ARRAY_AGG(name LIMIT 5)) as NAMES FROM testdata.satellites GROUP BY planetId", 7, 1, None),
        # 797
