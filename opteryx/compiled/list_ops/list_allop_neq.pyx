...
cpdef BoolVector list_allop_neq(object literal, ArrayVector vec):
    """
    Draken 'literal != ALL(row)' — True iff all non-null elements differ from literal. Null/empty row → False.
