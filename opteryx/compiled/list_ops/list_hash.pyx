...
cpdef StringVector list_md5(StringVector vec):
...
cpdef StringVector list_sha1(StringVector vec):
...
cpdef StringVector list_sha256(StringVector vec):
...
cpdef StringVector list_sha512(StringVector vec):
