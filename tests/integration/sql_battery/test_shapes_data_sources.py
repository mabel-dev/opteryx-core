...
-- AND name = 'Earth')
        ...
        ("SELECT * FROM testdata.satellites WHERE TRUE", 177, 8, None),
        ("SELECT * FROM testdata.satellites WHERE FALSE", 0, 8, None),
        ("SELECT * FROM testdata.satellites WHERE NOT TRUE", 0, 8, None),
        ("SELECT * FROM testdata.satellites WHERE NOT FALSE", 177, 8, None),
        ("SELECT * FROM testdata.satellites WHERE `name` = 'Calypso'", 1, 8, None),
        ("SELECT * FROM `testdata.satellites` WHERE name = 'Calypso'", 1, 8, None),
        ("SELECT * FROM `testdata.satellites` WHERE `name` = 'Calypso'", 1, 8, None),
