...
STATEMENTS = [
        ...
        ("/* 43 */ SELECT TRUNC(EventTime, 'minute') AS M, COUNT(*) AS PageViews FROM testdata.clickbench_tiny WHERE CounterID = 62 AND EventDate >= '2013-07-14' AND EventDate <= '2013-07-15' AND IsRefresh = 0 AND DontCountHits = 0 GROUP BY TRUNC(EventTime, 'minute') ORDER BY M LIMIT 10 OFFSET 1000;", None),
]
# fmt:on
