...
ROWS = 300_000  # 4 x 65,536 + a remainder: five row groups
...
def test_ctas_lands_as_one_file_of_five_row_groups(tmp_path):
    ...
    assert _row_group_count(os.path.join(str(tmp_path), "ws", "big", files[0])) == 5
