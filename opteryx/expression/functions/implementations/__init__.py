...
- arithmetic: ROUND, FLOOR, CEILING, ABS, SIGN, SQRT, TRUNCATE, POWER, LN, LOG10, LOG2, LOG
...
- utility: ARRAY_CONTAINS, ARRAY_CONTAINS_ANY, ARRAY_CONTAINS_ALL, GET_STRING, SORT, GREATEST, LEAST, JSONB_OBJECT_KEYS, HUMANIZE, COSINE_SIMILARITY, RANDOM, RAND, NORMAL, RANDOM_STRING
