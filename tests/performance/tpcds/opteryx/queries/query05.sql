  ...
  (SELECT s_store_id,
   ...
   FROM
     (SELECT ss_store_sk AS store_sk,
      ...
      FROM testdata.tpcds_tiny.store_returns ) salesreturns,
  ...
  (SELECT cp_catalog_page_id,
   ...
   FROM
     (SELECT cs_catalog_page_sk AS page_sk,
      ...
      FROM testdata.tpcds_tiny.catalog_returns ) salesreturns,
        testdata.tpcds_tiny.date_dim,
  ...
  (SELECT web_site_id,
   ...
   FROM
     (SELECT ws_web_site_sk AS wsr_web_site_sk,
      ...
      FROM testdata.tpcds_tiny.web_returns
      LEFT OUTER JOIN testdata.tpcds_tiny.web_sales ON (wr_item_sk = ws_item_sk
